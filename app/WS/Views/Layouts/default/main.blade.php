...
<body class="domainBase  d-flex vh-100 flex-column">
  <div id="root" class="@yield('domain_alias')">
    {{-- Incluir el sidebar --}}
    @include('ws::Layouts.default.navegation')
    <main>
      {{-- Incluir el header --}}
      @include('ws::Layouts.default.header')
      
      {{-- Contenido scrollable --}}
      @yield('content')
      

      {{-- IncluirWorkspaceel header --}}
      @include('ws::Layouts.default.footer')
    </main>
  </div>
